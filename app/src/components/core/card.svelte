...
<div on:click class="group relative block h-40 sm:h-40 lg:h-40">
  ...
  >
    ...
    >
      ...
      <h2 class="mt-4 text-xl font-medium sm:text-2xl">{bounty.name}</h2>
    </div>

    <div
      class="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8"
    >
      <h3 class="mt-4 text-xl font-medium sm:text-2xl">Claim Bounty</h3>

      <p class="mt-4 text-sm sm:text-base">
        Click to enter the claim for this bounty!
      </p>

      <p class="mt-8 font-bold">Reward: {bounty.qty}</p>
    </div>
  </div>
</div>
